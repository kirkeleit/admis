...
<?php if (isset($Faggruppe['Leder'])) { ?>
  <p>
    <label for="Leder">Leder:</label>
    <a href="<?php echo site_url(); ?>/kontakter/person/<?php echo $Faggruppe['Leder']['ID']; ?>"><?php echo $Faggruppe['Leder']['Navn']; ?></a>
  </p>
<?php } ?>

<?php if (isset($Faggruppe['Nestleder'])) { ?>
  <p>
    <label for="NestlederID">Nestleder:</label>
    <a href="<?php echo site_url(); ?>/kontakter/person/<?php echo $Faggruppe['Nestleder']['ID']; ?>"><?php echo $Faggruppe['Nestleder']['Navn']; ?></a>
  </p>
<?php } ?>
