<h3 class="sub-header">Organisasjoner <a href="<?php echo site_url('/kontakter/nyorganisasjon'); ?>" class="btn btn-default" role="button"><span class="glyphicon glyphicon-plus"></span></a></h3>
