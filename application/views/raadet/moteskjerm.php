...
?>
  <li><a href="<?php echo site_url('/raadet/moteskjerm/?mid='.$Mote['MoteID'].'&sid='.$SaksInfo['SakID']); ?>"><?php echo $SaksInfo['SaksAr']."/".$SaksInfo['SaksNummer']; ?></a></li>
<?php
    }
  }
?>
...
<?php echo form_open('/raadet/moteskjerm/?mid='.$Mote['MoteID'].'&sid='.$Sak['SakID']); ?>
...
<div id="Sak">
  ...
  <p>
    <label>&nbsp;</label>
    <input type="submit" value="Lagre" name="LagreMote" />&nbsp;<input type="submit" value="Start møte" name="StartMote" />&nbsp;<input type="submit" value="Avslutt møte" name="AvsluttMote" />
  </p>
</div>
<?php } ?>
